...
class ShockUtils {
    ...
    companion object {
        const val SHOCK_SHARED_PREFS = "shock_shared_prefs"
        const val STARTING_ID = 1000
        const val MEDIA_UPDATED_ACTION = "MEDIA_UPDATED_ACTION"

        fun getRawUri(context: Context, assetName: String): Uri {
            return Uri.parse(
                ContentResolver.SCHEME_ANDROID_RESOURCE + File.pathSeparator + File.separator +
